                    ...
                    if(mysqli_num_rows($transactions) > 0){ // Jika ditemukan pemesanan pada tanggal yang dicari
                        foreach ($jadwals as $jadwal){
                            ...
                            if($dipesan){
                                ...
                                if(isDateExpired($date, $jadwal['waktu'])){
                                    ...
                                    echo '<td><a href="?hal=kelola_transaksi_tambah&tanggal='.$date.'&idLapang=2&idJadwal='.$jadwal['id_jadwal'].'">Tambah</a></td>';
                                }
                            }
                            echo '</tr>';
                        }
                        ...
                        foreach($jadwals as $jadwal){
                            ...
                            if(isDateExpired($date, $jadwal['waktu'])){
                                ...
                                echo '<td><a href="?hal=pesan&tanggal='.$date.'&idLapang=2&idJadwal='.$jadwal['id_jadwal'].'">Tambah</a></td>';
                            }
                            echo '</tr>';
                        }
                    }
