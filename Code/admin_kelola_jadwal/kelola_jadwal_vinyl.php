...
?>
        <div class="jdwl">
            ...
            <table border="1" width="1250px" class="tab">
                <tr><th class="abu" colspan="5"> Tanggal : <?= reverseDate($date) ?> </th></tr>
                <tr class="abu">
                    <th>Waktu</th>
                    <th>Harga</th>
                    <th>Status</th>
                        ...
                        foreach ($jadwals as $jadwal){
                            ...
                            if($dipesan){
                                ...
                                if(isDateExpired($date, $jadwal['waktu'])){
                                    ...
                                    echo '<td><a class="ubah" href="?hal=kelola_transaksi_tambah&tanggal='.$date.'&idLapang=2&idJadwal='.$jadwal['id_jadwal'].'">Tambah</a></td>';
                                }
                            }
                            echo '</tr>';
                        }
