                        ...
                        if(mysqli_num_rows($transactions) > 0){ // Jika ditemukan pemesanan pada tanggal yang dicari
                            foreach ($jadwals as $jadwal){
                                ...
                                foreach($transactions as $transaction) {
                                    if($transaction['id_lapang'] == 2 && $jadwal['id_jadwal'] == $transaction['id_jadwal']){
                                        $dipesan = true;
                                ...
                                if($dipesan){
                                    ...
                                    echo '<td class="align-middle"><a class="btn btn-danger" href="?hal=kelola_transaksi_hapus&id='.$idTransaction.'&idLapang=2">Hapus</a></td>';
                                    $dipesan = false;
                                } else {
                                    ...
                                    if(isDateExpired($date, $jadwal['waktu'])){
                                        ...
                                        echo '<td class="align-middle"><a class="btn btn-success" href="?hal=kelola_transaksi_tambah&tanggal='.$date.'&idLapang=2&idJadwal='.$jadwal['id_jadwal'].'">Tambah</a></td>';
                                    }
                                }
                                echo '</tr>';
                            }
