                    ...
                    <div class="navbar-nav">
                        ...
                        <div class="dropdown show mr-4">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="?hal=kelola_jadwal_sintesis">Jadwal Sintesis</a>
                                <a class="dropdown-item" href="?hal=kelola_jadwal_vinyl">Jadwal Vinyl</a>
                            </div>
                        </div>
                        <a href="?hal=kelola_akun" class="nav-item nav-link mr-4" style="font-size:20px;">Kelola Akun</a>
                        <a href="?hal=kelola_transaksi" class="nav-item nav-link mr-4" style="font-size:20px;">Kelola Transaksi</a>
                        <a href="?hal=admin_logout" class="nav-item nav-link mr-4" style="font-size:20px;">Logout</a>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <div class="container-fluid bg-dark p-4">
            <div class="row">
                <div class="col-md-4 text-light">
                    ...
                    <hr class="bg-light">
                    <div class="row d-flex justify-content-center align-items-center">
                        <a href=""><img width="80px" class="insta" src="../assets/img/ig.png" alt="Instagram"></a>
                        <!-- </div> -->
                        <!-- <div class="bawahkiri"> -->
                        <a href=""><img width="100px" class="manuk" src="../assets/img/twtr.png" alt="Twitter"></a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="container-fluid">
